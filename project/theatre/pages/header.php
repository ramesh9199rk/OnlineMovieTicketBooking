...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="ar1.jpeg" class="user-image" alt="User Image">
              <!--<img src="vishal.jpg" class="user-image" alt="User Image">-->
              <span class="hidden-xs"><?php echo $theatre['name'];?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                  <img src="ar1.jpeg" class="img-circle" alt="User Image">
               <!-- <img src="vishal.jpg" class="img-circle" alt="User Image">-->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <!-- Sidebar user panel   this is 109  code -->
